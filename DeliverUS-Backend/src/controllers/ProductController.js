...
const create = async function (req, res) {
  ...
  try {
    // SOLUCIÓN: basePrice updated from price property (given in the student's base project)
...
const update = async function (req, res) {
  try {
    // SOLUCIÓN: basePrice updated from new price property (given in the student's base project)
